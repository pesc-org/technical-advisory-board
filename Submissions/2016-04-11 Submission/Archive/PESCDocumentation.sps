...
<structure version="16" html-doctype="HTML4 Transitional" compatibility-view="IE9" relativeto="*XML" encodinghtml="UTF-8" encodingrtf="ISO-8859-1" encodingpdf="UTF-8" useimportschema="1" embed-images="1" enable-authentic-scripts="1" authentic-scripts-in-debug-mode-external="0" generated-file-location="DEFAULT">
	...
	<schemasources>
		...
		<schemasources>
			<xsdschemasource name="XML" main="1" schemafile="C:\Users\morrism\Documents\Altova\XMLSpy2015\Documentation\Schema\SchemaDocumentation.xsd" workingxmlfile="C:\Users\morrism\Documents\Altova\XMLSpy2015\Documentation\Schema\SampleData\Sample.xml"/>
		</schemasources>
	</schemasources>
	<modules/>
	<flags>
	...
	<designfragments>
		<children>
						...
						<children>
							...
							<tgridbody-rows>
								<children>
													...
													<tgridcell>
														...
														<children>
															<text fixtext="Diagram">
																<styles font-family="inherit" font-size="smaller" font-style="italic"/>
															</text>
															<newline/>
														</children>
													</tgridcell>
												...
												<children>
													...
													<tgridcell>
														<children>
															<condition>
																<children>
																	<conditionbranch xpath="not(exists(n1:Property[@name=&apos;minOcc&apos;]))">
																		<children>
																			<text fixtext="Required"/>
																		</children>
																	</conditionbranch>
																	<conditionbranch xpath="n1:Property[@name=&apos;minOcc&apos;]/text()=&apos;1&apos;">
																		<children>
																			<text fixtext="Required"/>
																		</children>
																	</conditionbranch>
																	<conditionbranch xpath="n1:Property[@name=&apos;minOcc&apos;]/text()=&apos;0&apos;">
																		<children>
															...
															<condition>
																<children>
																	<conditionbranch xpath="exists(n1:Property[@name=&apos;maxOcc&apos; ])and (n1:Property[@name=&apos;maxOcc&apos;]/text()=&apos;unbounded&apos; or n1:Property[@name=&apos;maxOcc&apos;]/text()!=&apos;1&apos;)">
																		<children>
																			<text fixtext="; Repeatable"/>
																		</children>
																	</conditionbranch>
																</children>
															</condition>
												...
												<children>
													...
													<tgridcell>
														...
														<children>
															<content subtype="regular">
																<properties class="schemaSubData"/>
																<styles font-size="smaller" font-style="normal"/>
															</content>
														</children>
													</tgridcell>
												</children>
									...
									<template subtype="element" filter="./n1:Facet/@kind=&apos;enumeration&apos;" match="n1:Facets">
										<children>
											<tgridrow>
												<children>
													<tgridcell>
														<styles text-align="right"/>
														<children>
															<text fixtext="Enumerations">
																<styles font-size="smaller" font-style="italic" text-align="right"/>
															</text>
														</children>
													</tgridcell>
													<tgridcell>
																					...
																					<tgridcell>
																						<children>
																							<text fixtext="Description">
																								<properties class="schemaSubTitle"/>
																								<styles font-style="normal" font-weight="200" word-wrap="normal"/>
																							</text>
																						</children>
																					</tgridcell>
																				</children>
																			</tgridrow>
																			<template subtype="element" filter="@kind=&apos;enumeration&apos;" match="n1:Facet">
																				<children>
																					<tgridrow>
																						<styles height="auto"/>
																						<children>
											...
											<tgridrow>
												<children>
													<tgridcell>
														<properties align="right" valign="top"/>
														<children>
															<text fixtext="Identity Constraints">
																<styles font-size="smaller" font-style="italic"/>
															</text>
														</children>
													</tgridcell>
			...
			<globaltemplate subtype="named" match="RequiredElement">
				<parameters/>
				<children>
					<condition>
						<children>
							...
							<conditionbranch xpath="n1:Property[@name=&apos;minOcc&apos;]/text()=&apos;1&apos;">
								<children>
									<text fixtext="Required Explicit"/>
								</children>
							</conditionbranch>
							<conditionbranch xpath="n1:Property[@name=&apos;minOcc&apos;]/text()=&apos;0&apos;">
								<children>
