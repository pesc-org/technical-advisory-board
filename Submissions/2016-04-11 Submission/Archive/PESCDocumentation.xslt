...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:n1="http://www.altova.com/documentation" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;NewDocumentation&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:import-schema schema-location="C:\Users\morrism.CORPORATE\Documents\Altova\XMLSpy2015\Documentation\Schema\SchemaDocumentation.xsd" namespace="http://www.altova.com/documentation"/>
	...
	<xsl:variable name="altova:DocumentMonolith">
		<altova:Document altova:Url="{if ($SV_BaseOutputFileName) then concat($SV_BaseOutputFileName,'.rtf') else ''}">
			...
			<altova:DocumentProperties altova:Author="" altova:Keywords="" altova:Subject="" altova:Title="{$XML/n1:SchemaDocumentation/n1:Document/@title}"/>
			<xsl:text>\dntblnsbdb\fs24\f0</xsl:text>
			<altova:DocumentSection altova:PageWidthPt="612" altova:MarginLeftPt="43" altova:MarginRightPt="43" altova:PageHeightPt="792" altova:MarginTopPt="56" altova:MarginBottomPt="56" altova:Columns="1" altova:ColumnGapPt="36"/>
			<xsl:text>\sectd\facingp\pgwsxn12240\pghsxn15840\margtsxn-1120\marglsxn860\margbsxn-1120\margrsxn860\headery420\footery420\cols1\colsx720\pgndec</xsl:text>
			<xsl:text>{</xsl:text>
			...
			<xsl:for-each select="$XML">
				<xsl:for-each select="n1:SchemaDocumentation">
					<xsl:for-each select="n1:Document">
						<xsl:for-each select="@title">
							<altova:paragraph altova:selector="div" altova:character-styles="\f0\fs24" altova:is-div="true">
								<altova:bookmark name="{&apos;toc&apos;}">
									<altova:text-block altova:selector=".schemaHeader" altova:character-styles="\cf3\f1\fs21" altova:character-reset-styles="\cf0\f0\fs24">
										<xsl:text>\u83?\u99?\u104?\u101?\u109?\u97?\u32?</xsl:text>
									</altova:text-block>
									<altova:text-block altova:selector=".schemaHeader2" altova:character-styles="\cf3\f1\fs21\b" altova:character-reset-styles="\cf0\f0\fs24\b0">
					...
					<altova:new-line/>
					<altova:new-line/>
					<xsl:apply-templates select="n1:SchemaDocument">
						<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
					</xsl:apply-templates>
					<xsl:for-each select="n1:SchemaDocument">
						<xsl:for-each select="element()[local-name() != &quot;DefaultOpenContent&quot;]">
							<xsl:choose>
								<xsl:when test="@newFile">
									<altova:Document altova:Url="{altova:map-preview-filepath(concat(@newFile, '.rtf'))}">
										<xsl:variable name="templatetablelevel" select="0"/>
										<altova:DocumentProperties altova:Author="" altova:Keywords="" altova:Subject="" altova:Title="{concat($XML/n1:SchemaDocumentation/n1:Document/@title,' - ',@name)}"/>
										<xsl:text>\dntblnsbdb\fs24\f0</xsl:text>
										<altova:DocumentSection altova:PageWidthPt="612" altova:MarginLeftPt="43" altova:MarginRightPt="43" altova:PageHeightPt="792" altova:MarginTopPt="56" altova:MarginBottomPt="56" altova:Columns="1" altova:ColumnGapPt="36"/>
										<xsl:text>\sectd\facingp\pgwsxn12240\pghsxn15840\margtsxn-1120\marglsxn860\margbsxn-1120\margrsxn860\headery420\footery420\cols1\colsx720\pgndec</xsl:text>
										<xsl:text>{</xsl:text>
										...
										<xsl:text>{</xsl:text>
										<xsl:text>\footerl </xsl:text>
										<xsl:call-template name="altova:Section_1_FooterLeft"/>
										<xsl:text>}</xsl:text>
										<xsl:text>{</xsl:text>
										<xsl:text>\footerr </xsl:text>
										<xsl:call-template name="altova:Section_1_FooterRight"/>
										<xsl:text>}</xsl:text>
										<altova:AfterHeadersFooters/>
										...
										<altova:paragraph altova:selector="div" altova:character-styles="\f0\fs24" altova:is-div="true">
											<altova:link altova:Dest="{&apos;#toc&apos;}">
												<altova:text-block altova:selector=".schemaName" altova:character-styles="\cf3\f1\fs16\i\b" altova:character-reset-styles="\cf0\f0\fs24\i0\b0">
													<xsl:text>\u66?\u97?\u99?\u107?\u32?\u116?\u111?\u32?\u84?\u79?\u67?</xsl:text>
												</altova:text-block>
											</altova:link>
										</altova:paragraph>
										<altova:new-line/>
										<xsl:if test="$SV_OutputFormat = &apos;HTML&apos;">
	...
	<xsl:variable name="altova:nodesAllDocumentEntryPoints" as="node()+" select="$altova:DocumentMonolith//altova:Document"/>
	<xsl:variable name="altova:nodesAllSeparateDocuments" as="node()+" select="for $nodeDocumentEntryPoint in $altova:nodesAllDocumentEntryPoints return altova:CopyOwnDocument($nodeDocumentEntryPoint)"/>
	<xsl:template match="n1:Attribute">
		<xsl:param name="templatetablelevel" select="0"/>
		<xsl:call-template name="SchemaItem">
			<xsl:with-param name="type" select="&apos;attribute&apos;"/>
			<xsl:with-param name="backgroundColor" select="&apos;#FFD9CC&apos;"/>
			<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
		</xsl:call-template>
	</xsl:template>
	<xsl:template match="n1:Element">
		<xsl:param name="templatetablelevel" select="0"/>
		<xsl:call-template name="SchemaItem">
			<xsl:with-param name="type" select="&apos;element&apos;"/>
			<xsl:with-param name="backgroundColor" select="&apos;#F0F0F0&apos;"/>
			<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
		</xsl:call-template>
	</xsl:template>
	<xsl:template match="n1:ComplexType">
		<xsl:param name="templatetablelevel" select="0"/>
		<xsl:call-template name="SchemaItem">
			<xsl:with-param name="type" select="&apos;complexType&apos;"/>
			<xsl:with-param name="backgroundColor" select="&apos;#C9CDE0&apos;"/>
			<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
		</xsl:call-template>
	</xsl:template>
	<xsl:template match="n1:SimpleType">
		<xsl:param name="templatetablelevel" select="0"/>
		<xsl:call-template name="SchemaItem">
			<xsl:with-param name="type" select="&apos;simpleType&apos;"/>
			<xsl:with-param name="backgroundColor" select="&apos;#BAC0E0&apos;"/>
			<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
		</xsl:call-template>
	</xsl:template>
	<xsl:template match="n1:Reference">
		<xsl:param name="templatetablelevel" select="0"/>
		<xsl:call-template name="RefContent_FontName">
			<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
		</xsl:call-template>
	</xsl:template>
	<xsl:template match="n1:Restriction">
		<xsl:param name="templatetablelevel" select="0"/>
		<altova:text-block altova:selector=".schemaSubData" altova:character-styles="\cf3\f1\fs16" altova:character-reset-styles="\cf0\f0\fs24">
			<xsl:text>\u114?\u101?\u115?\u116?\u114?\u105?\u99?\u116?\u105?\u111?\u110?\u32?\u111?\u102?\u32?</xsl:text>
		</altova:text-block>
		<altova:text-block>
			<xsl:apply-templates/>
		</altova:text-block>
	...
	<xsl:template match="n1:Extension">
		<xsl:param name="templatetablelevel" select="0"/>
		<altova:text-block altova:selector=".schemaSubData" altova:character-styles="\cf3\f1\fs16" altova:character-reset-styles="\cf0\f0\fs24">
			<xsl:text>\u101?\u120?\u116?\u101?\u110?\u115?\u105?\u111?\u110?\u32?\u111?\u102?\u32?</xsl:text>
		</altova:text-block>
		<altova:text-block>
			<xsl:apply-templates/>
		</altova:text-block>
	...
	<xsl:template match="n1:List">
		<xsl:param name="templatetablelevel" select="0"/>
		<altova:text-block altova:selector=".schemaSubData" altova:character-styles="\cf3\f1\fs16" altova:character-reset-styles="\cf0\f0\fs24">
			<xsl:text>\u108?\u105?\u115?\u116?\u32?\u111?\u102?\u32?</xsl:text>
		</altova:text-block>
		<altova:text-block>
			<xsl:apply-templates/>
		</altova:text-block>
	</xsl:template>
	<xsl:template match="n1:Union">
		<xsl:param name="templatetablelevel" select="0"/>
		<altova:text-block altova:selector=".schemaSubData" altova:character-styles="\cf3\f1\fs16" altova:character-reset-styles="\cf0\f0\fs24">
			<xsl:text>\u117?\u110?\u105?\u111?\u110?\u32?\u111?\u102?\u32?</xsl:text>
		</altova:text-block>
		<altova:text-block>
			<xsl:apply-templates/>
		</altova:text-block>
	</xsl:template>
	<xsl:template match="n1:Group">
		<xsl:param name="templatetablelevel" select="0"/>
		<xsl:call-template name="SchemaItem">
			<xsl:with-param name="type" select="&apos;group&apos;"/>
			<xsl:with-param name="backgroundColor" select="&apos;#E6E8F2&apos;"/>
			<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
		</xsl:call-template>
	</xsl:template>
	<xsl:template match="n1:AttributeGroup">
		<xsl:param name="templatetablelevel" select="0"/>
		<xsl:call-template name="SchemaItem">
			<xsl:with-param name="type" select="&apos;attributeGroup&apos;"/>
			<xsl:with-param name="backgroundColor" select="&apos;#FFC6B2&apos;"/>
			<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
		</xsl:call-template>
	</xsl:template>
	<xsl:template match="n1:Notation">
		<xsl:param name="templatetablelevel" select="0"/>
		<xsl:call-template name="SchemaItem">
			<xsl:with-param name="type" select="&apos;notation&apos;"/>
			<xsl:with-param name="backgroundColor" select="&apos;#FFF0D0&apos;"/>
			<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
		</xsl:call-template>
	</xsl:template>
	<xsl:template match="n1:SchemaDocument">
		<xsl:param name="templatetablelevel" select="0"/>
		...
		<xsl:variable name="altova:table">
			<altova:table altova:hide-rows="body-empty">
				...
				<altova:TableStyles altova:nBorderSpacingPt="0.00" altova:sBorderCollapse="separate" altova:nCellPaddingPt="1.50" altova:nLeftMarginPt="0.00">
				...
				<altova:table-row>
					...
					<altova:table-cell altova:is-body-cell="true" altova:character-styles="\cf4\f1\fs16\i" altova:character-reset-styles="\cf0\f0\fs24\i0" altova:paragraph-styles="\ql\sl0">
						<altova:TableCellStyles altova:nColSpan="1">
							<xsl:text>\clvertalc</xsl:text>
						</altova:TableCellStyles>
						<altova:text-block altova:character-styles="\b0">
							<xsl:text>\u115?\u99?\u104?\u101?\u109?\u97?\u32?\u108?\u111?\u99?\u97?\u116?\u105?\u111?\u110?\u58?</xsl:text>
						</altova:text-block>
					</altova:table-cell>
					<altova:table-cell altova:is-body-cell="true" altova:character-styles="\cf3\f1\fs16\b" altova:character-reset-styles="\cf0\f0\fs24\b0" altova:paragraph-styles="\sl0">
						<altova:TableCellStyles altova:nColSpan="1">
							<xsl:text>\clvertalc</xsl:text>
						</altova:TableCellStyles>
						<altova:bookmark name="{@schemaLocation}">
							<altova:link altova:Dest="{@href}">
								<xsl:for-each select="@schemaLocation">
									<altova:text-block altova:selector=".schemaName" altova:character-styles="\cf3\f1\fs16\b" altova:character-reset-styles="\cf0\f0\fs24\b0">
										<altova:string-to-unicode>
											<xsl:value-of select="string(.)"/>
										</altova:string-to-unicode>
									</altova:text-block>
				...
				<altova:table-row>
					...
					<altova:table-cell altova:is-body-cell="true" altova:character-styles="\cf4\f1\fs16\i" altova:character-reset-styles="\cf0\f0\fs24\i0" altova:paragraph-styles="\ql\sl0">
						...
						<altova:text-block altova:character-styles="\b0">
							<xsl:text>\u97?\u116?\u116?\u114?\u105?\u98?\u117?\u116?\u101?\u70?\u111?\u114?\u109?\u68?\u101?\u102?\u97?\u117?\u108?\u116?\u58?</xsl:text>
						</altova:text-block>
					</altova:table-cell>
					<altova:table-cell altova:is-body-cell="true" altova:character-styles="\cf3\f1\fs16\b" altova:character-reset-styles="\cf0\f0\fs24\b0" altova:paragraph-styles="\sl0">
						<altova:TableCellStyles altova:nColSpan="1">
						...
						<xsl:for-each select="@attributeFormDefault">
							<altova:text-block altova:selector=".schemaName" altova:character-styles="\cf3\f1\fs16\b" altova:character-reset-styles="\cf0\f0\fs24\b0">
								<altova:string-to-unicode>
									<xsl:value-of select="string(.)"/>
								</altova:string-to-unicode>
				...
				<altova:table-row>
					...
					<altova:table-cell altova:is-body-cell="true" altova:character-styles="\cf4\f1\fs16\i" altova:character-reset-styles="\cf0\f0\fs24\i0" altova:paragraph-styles="\ql\sl0">
						...
						<altova:text-block altova:character-styles="\b0">
							<xsl:text>\u101?\u108?\u101?\u109?\u101?\u110?\u116?\u70?\u111?\u114?\u109?\u68?\u101?\u102?\u97?\u117?\u108?\u116?\u58?</xsl:text>
						</altova:text-block>
					</altova:table-cell>
					<altova:table-cell altova:is-body-cell="true" altova:character-styles="\cf3\f1\fs16\b" altova:character-reset-styles="\cf0\f0\fs24\b0" altova:paragraph-styles="\sl0">
						<altova:TableCellStyles altova:nColSpan="1">
						...
						<xsl:for-each select="@elementFormDefault">
							<altova:text-block altova:selector=".schemaName" altova:character-styles="\cf3\f1\fs16\b" altova:character-reset-styles="\cf0\f0\fs24\b0">
								<altova:string-to-unicode>
									<xsl:value-of select="string(.)"/>
								</altova:string-to-unicode>
				...
				<altova:table-row>
					...
					<altova:table-cell altova:is-body-cell="true" altova:character-styles="\cf4\f1\fs16\i" altova:character-reset-styles="\cf0\f0\fs24\i0" altova:paragraph-styles="\ql\sl0">
						...
						<altova:text-block altova:character-styles="\b0">
							<xsl:text>\u98?\u108?\u111?\u99?\u107?\u68?\u101?\u102?\u97?\u117?\u108?\u116?\u58?</xsl:text>
						</altova:text-block>
					</altova:table-cell>
					<altova:table-cell altova:is-body-cell="true" altova:character-styles="\cf3\f1\fs16\b" altova:character-reset-styles="\cf0\f0\fs24\b0" altova:paragraph-styles="\sl0">
						<altova:TableCellStyles altova:nColSpan="1">
				...
				<altova:table-row>
					...
					<altova:table-cell altova:is-body-cell="true" altova:character-styles="\cf4\f1\fs16\i" altova:character-reset-styles="\cf0\f0\fs24\i0" altova:paragraph-styles="\ql\sl0">
						...
						<altova:text-block altova:character-styles="\b0">
							<xsl:text>\u102?\u105?\u110?\u97?\u108?\u68?\u101?\u102?\u97?\u117?\u108?\u116?\u58?</xsl:text>
						</altova:text-block>
					</altova:table-cell>
					<altova:table-cell altova:is-body-cell="true" altova:character-styles="\cf3\f1\fs16\b" altova:character-reset-styles="\cf0\f0\fs24\b0" altova:paragraph-styles="\sl0">
						<altova:TableCellStyles altova:nColSpan="1">
				...
				<altova:table-row>
					...
					<altova:table-cell altova:is-body-cell="true" altova:character-styles="\cf4\f1\fs16\i" altova:character-reset-styles="\cf0\f0\fs24\i0" altova:paragraph-styles="\ql\sl0">
						...
						<altova:text-block altova:character-styles="\b0">
							<xsl:text>\u120?\u112?\u97?\u116?\u104?\u68?\u101?\u102?\u97?\u117?\u108?\u116?\u78?\u97?\u109?\u101?\u115?\u112?\u97?\u99?\u101?\u58?</xsl:text>
						</altova:text-block>
					</altova:table-cell>
					<altova:table-cell altova:is-body-cell="true" altova:character-styles="\cf3\f1\fs16\b" altova:character-reset-styles="\cf0\f0\fs24\b0" altova:paragraph-styles="\sl0">
						<altova:TableCellStyles altova:nColSpan="1">
						...
						<xsl:for-each select="@xpathDefaultNamespace">
							<altova:text-block altova:selector=".schemaName" altova:character-styles="\cf3\f1\fs16\b" altova:character-reset-styles="\cf0\f0\fs24\b0">
								<altova:string-to-unicode>
									<xsl:value-of select="string(.)"/>
								</altova:string-to-unicode>
				...
				<altova:table-row>
					...
					<altova:table-cell altova:is-body-cell="true" altova:character-styles="\cf4\f1\fs16\i" altova:character-reset-styles="\cf0\f0\fs24\i0" altova:paragraph-styles="\ql\sl0">
						...
						<altova:text-block altova:character-styles="\b0">
							<xsl:text>\u100?\u101?\u102?\u97?\u117?\u108?\u116?\u65?\u116?\u116?\u114?\u105?\u98?\u117?\u116?\u101?\u115?\u58?</xsl:text>
						</altova:text-block>
					</altova:table-cell>
					<altova:table-cell altova:is-body-cell="true" altova:character-styles="\cf3\f1\fs16\b" altova:character-reset-styles="\cf0\f0\fs24\b0" altova:paragraph-styles="\sl0">
						<altova:TableCellStyles altova:nColSpan="1">
						...
						<xsl:choose>
							<xsl:when test="@defaultAttributes_ref">
								<altova:link altova:Dest="{concat(&apos;#&apos;,@defaultAttributes_ref)}">
									<xsl:for-each select="@defaultAttributes">
										<altova:text-block altova:selector=".schemaName" altova:character-styles="\cf3\f1\fs16\b" altova:character-reset-styles="\cf0\f0\fs24\b0">
											<altova:string-to-unicode>
												<xsl:value-of select="string(.)"/>
											</altova:string-to-unicode>
				...
				<altova:table-row>
					...
					<altova:table-cell altova:is-body-cell="true" altova:character-styles="\cf4\f1\fs16\i" altova:character-reset-styles="\cf0\f0\fs24\i0" altova:paragraph-styles="\ql\sl0">
						...
						<altova:text-block altova:character-styles="\b0">
							<xsl:text>\u116?\u97?\u114?\u103?\u101?\u116?\u78?\u97?\u109?\u101?\u115?\u112?\u97?\u99?\u101?\u58?</xsl:text>
						</altova:text-block>
					</altova:table-cell>
					<altova:table-cell altova:is-body-cell="true" altova:character-styles="\cf3\f1\fs16\b" altova:character-reset-styles="\cf0\f0\fs24\b0" altova:paragraph-styles="\sl0">
						<altova:TableCellStyles altova:nColSpan="1">
				...
				<xsl:for-each select="n1:DefaultOpenContent">
					<altova:table-row>
						<xsl:element name="altova:TableRowStyles">
							<xsl:text>\trrh0</xsl:text>
						</xsl:element>
						<altova:table-cell altova:is-body-cell="true" altova:character-styles="\cf4\f1\fs16\i" altova:character-reset-styles="\cf0\f0\fs24\i0" altova:paragraph-styles="\ql\sl0">
							...
							<altova:text-block altova:character-styles="\b0">
								<xsl:text>\u100?\u101?\u102?\u97?\u117?\u108?\u116?\u79?\u112?\u101?\u110?\u67?\u111?\u110?\u116?\u101?\u110?\u116?\u58?</xsl:text>
							</altova:text-block>
						</altova:table-cell>
						<altova:table-cell altova:is-body-cell="true" altova:paragraph-styles="\sl0">
							<altova:TableCellStyles altova:nColSpan="1">
								<xsl:text>\clvertalc</xsl:text>
							</altova:TableCellStyles>
							...
							<altova:table>
								...
								<altova:TableGrid>
									...
									<altova:GridCol altova:sWidth="72" altova:sType="twips"/>
									<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
									<altova:GridCol altova:sWidth="72" altova:sType="twips"/>
									<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
									<altova:GridCol altova:sWidth="72" altova:sType="twips"/>
								...
								<altova:table-row>
									...
									<altova:table-cell altova:paragraph-styles="\ql\sl0">
										...
										<altova:text-block altova:selector=".schemaSubTitle" altova:character-styles="\cf4\f1\fs16\i" altova:character-reset-styles="\cf0\f0\fs24\i0">
											<xsl:text>\u77?\u111?\u100?\u101?</xsl:text>
										</altova:text-block>
									</altova:table-cell>
									...
									<altova:table-cell altova:paragraph-styles="\ql\sl0">
										...
										<altova:text-block altova:selector=".schemaSubTitle" altova:character-styles="\cf4\f1\fs16\i" altova:character-reset-styles="\cf0\f0\fs24\i0">
											<xsl:text>\u65?\u112?\u112?\u108?\u105?\u101?\u115?\u84?\u111?\u69?\u109?\u112?\u116?\u121?</xsl:text>
										</altova:text-block>
									</altova:table-cell>
									<altova:table-cell altova:paragraph-styles="\sl0">
										<altova:TableCellStyles altova:nColSpan="1">
									...
									<altova:table-cell altova:paragraph-styles="\ql\sl0">
										...
										<xsl:choose>
											<xsl:when test="n1:DefaultOpenContent/@notNamespace">
												<altova:text-block altova:selector=".schemaSubTitle" altova:character-styles="\cf4\f1\fs16\i" altova:character-reset-styles="\cf0\f0\fs24\i0">
													<xsl:text>\u110?\u111?\u116?\u78?\u97?\u109?\u101?\u115?\u112?\u97?\u99?\u101?</xsl:text>
												</altova:text-block>
											</xsl:when>
											<xsl:otherwise>
												<altova:text-block altova:selector=".schemaSubTitle" altova:character-styles="\cf4\f1\fs16\i" altova:character-reset-styles="\cf0\f0\fs24\i0">
													<xsl:text>\u78?\u97?\u109?\u101?\u115?\u112?\u97?\u99?\u101?</xsl:text>
												</altova:text-block>
											</xsl:otherwise>
										</xsl:choose>
									</altova:table-cell>
									...
									<altova:table-cell altova:paragraph-styles="\ql\sl0">
										...
										<altova:text-block altova:selector=".schemaSubTitle" altova:character-styles="\cf4\f1\fs16\i" altova:character-reset-styles="\cf0\f0\fs24\i0">
											<xsl:text>\u80?\u114?\u111?\u99?\u101?\u115?\u115?\u67?\u111?\u110?\u116?\u101?\u110?\u116?\u115?</xsl:text>
										</altova:text-block>
									</altova:table-cell>
									<altova:table-cell altova:paragraph-styles="\sl0">
										<altova:TableCellStyles altova:nColSpan="1">
									...
									<altova:table-cell altova:paragraph-styles="\ql\sl0">
										...
										<altova:text-block altova:selector=".schemaSubTitle" altova:character-styles="\cf4\f1\fs16\i" altova:character-reset-styles="\cf0\f0\fs24\i0">
											<xsl:text>\u65?\u110?\u110?\u111?\u116?\u97?\u116?\u105?\u111?\u110?</xsl:text>
										</altova:text-block>
									</altova:table-cell>
								</altova:table-row>
								<altova:table-row>
									...
									<altova:table-cell altova:paragraph-styles="\ql\sl0">
										...
										<xsl:for-each select="@appliesToEmpty">
											<altova:text-block altova:selector=".schemaName" altova:character-styles="\cf3\f1\fs16\b" altova:character-reset-styles="\cf0\f0\fs24\b0">
												<altova:string-to-unicode>
													<xsl:value-of select="string(.)"/>
												</altova:string-to-unicode>
									...
									<altova:table-cell altova:paragraph-styles="\ql\sl0">
										...
										<xsl:choose>
											<xsl:when test="@notNamespace">
												<xsl:for-each select="@notNamespace">
													<altova:text-block altova:selector=".schemaName" altova:character-styles="\cf3\f1\fs16\b" altova:character-reset-styles="\cf0\f0\fs24\b0">
														<altova:string-to-unicode>
															<xsl:value-of select="string(.)"/>
														</altova:string-to-unicode>
									...
									<altova:table-cell altova:paragraph-styles="\ql\sl0">
										...
										<xsl:for-each select="@processContents">
											<altova:text-block altova:selector=".schemaName" altova:character-styles="\cf3\f1\fs16\b" altova:character-reset-styles="\cf0\f0\fs24\b0">
												<altova:string-to-unicode>
													<xsl:value-of select="string(.)"/>
												</altova:string-to-unicode>
		...
		<xsl:variable name="altova:table">
			<altova:table altova:hide-cols="body-empty">
				<xsl:variable name="altova:ColumnData"/>
				<altova:TableGrid>
					<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
					<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
				...
				<altova:table-row>
					...
					<altova:table-cell altova:paragraph-styles="\ql\sl0">
						<altova:TableCellStyles altova:nColSpan="1">
							...
							<xsl:element name="altova:TableCellColor">
								<xsl:attribute name="altova:sValue" select="'#F0F0F0'"/>
							</xsl:element>
						</altova:TableCellStyles>
						<altova:text-block altova:selector=".schemaSubTitle" altova:character-styles="\cf4\f1\fs16\i\b0" altova:character-reset-styles="\cf0\f0\fs24\i0">
							<xsl:text>\u69?\u108?\u101?\u109?\u101?\u110?\u116?\u115?</xsl:text>
						</altova:text-block>
					</altova:table-cell>
					<altova:table-cell altova:paragraph-styles="\ql\sl0">
						<altova:TableCellStyles altova:nColSpan="1">
							<xsl:text>\clvertalc</xsl:text>
							<xsl:element name="altova:TableCellColor">
								<xsl:attribute name="altova:sValue" select="'#E6E8F2'"/>
							</xsl:element>
						</altova:TableCellStyles>
						<altova:text-block altova:selector=".schemaSubTitle" altova:character-styles="\cf4\f1\fs16\i\b0" altova:character-reset-styles="\cf0\f0\fs24\i0">
							<xsl:text>\u71?\u114?\u111?\u117?\u112?\u115?</xsl:text>
						</altova:text-block>
					</altova:table-cell>
					<altova:table-cell altova:paragraph-styles="\ql\sl0">
						<altova:TableCellStyles altova:nColSpan="1">
							<xsl:text>\clvertalt</xsl:text>
							<xsl:element name="altova:TableCellColor">
								<xsl:attribute name="altova:sValue" select="'#C9CDE0'"/>
							</xsl:element>
						</altova:TableCellStyles>
						<altova:text-block altova:selector=".schemaSubTitle" altova:character-styles="\cf4\f1\fs16\i\b0" altova:character-reset-styles="\cf0\f0\fs24\i0">
							<xsl:text>\u67?\u111?\u109?\u112?\u108?\u101?\u120?\u32?\u116?\u121?\u112?\u101?\u115?</xsl:text>
						</altova:text-block>
					</altova:table-cell>
					<altova:table-cell altova:paragraph-styles="\ql\sl0">
						<altova:TableCellStyles altova:nColSpan="1">
							<xsl:text>\clvertalt</xsl:text>
							<xsl:element name="altova:TableCellColor">
								<xsl:attribute name="altova:sValue" select="'#BAC0E0'"/>
							</xsl:element>
						</altova:TableCellStyles>
						<altova:text-block altova:selector=".schemaSubTitle" altova:character-styles="\cf4\f1\fs16\i\b0" altova:character-reset-styles="\cf0\f0\fs24\i0">
							<xsl:text>\u83?\u105?\u109?\u112?\u108?\u101?\u32?\u116?\u121?\u112?\u101?\u115?</xsl:text>
						</altova:text-block>
					</altova:table-cell>
					<altova:table-cell altova:paragraph-styles="\ql\sl0">
						<altova:TableCellStyles altova:nColSpan="1">
							<xsl:text>\clvertalt</xsl:text>
							<xsl:element name="altova:TableCellColor">
								<xsl:attribute name="altova:sValue" select="'#FFD9CC'"/>
							</xsl:element>
						</altova:TableCellStyles>
						<altova:text-block altova:selector=".schemaSubTitle" altova:character-styles="\cf4\f1\fs16\i\b0" altova:character-reset-styles="\cf0\f0\fs24\i0">
					...
					<altova:table-cell altova:paragraph-styles="\ql\sl0">
						<altova:TableCellStyles altova:nColSpan="1">
							<xsl:text>\clvertalc</xsl:text>
							<xsl:element name="altova:TableCellColor">
								<xsl:attribute name="altova:sValue" select="'#FFC6B2'"/>
							</xsl:element>
						</altova:TableCellStyles>
						<altova:text-block altova:selector=".schemaSubTitle" altova:character-styles="\cf4\f1\fs16\i\b0" altova:character-reset-styles="\cf0\f0\fs24\i0">
							<xsl:text>\u65?\u116?\u116?\u114?\u105?\u98?\u117?\u116?\u101?\u32?\u71?\u114?\u111?\u117?\u112?\u115?</xsl:text>
						</altova:text-block>
					</altova:table-cell>
					<altova:table-cell altova:paragraph-styles="\ql\sl0">
						<altova:TableCellStyles altova:nColSpan="1">
							<xsl:text>\clvertalc</xsl:text>
							<xsl:element name="altova:TableCellColor">
								<xsl:attribute name="altova:sValue" select="'#FFF0D0'"/>
							</xsl:element>
						</altova:TableCellStyles>
						<altova:text-block altova:selector=".schemaSubTitle" altova:character-styles="\cf4\f1\fs16\i\b0" altova:character-reset-styles="\cf0\f0\fs24\i0">
							<xsl:text>\u78?\u111?\u116?\u97?\u116?\u105?\u111?\u110?\u115?</xsl:text>
						</altova:text-block>
					</altova:table-cell>
				</altova:table-row>
				<altova:table-row>
					...
					<altova:table-cell altova:is-body-cell="true" altova:paragraph-styles="\ql\sl0">
						<altova:TableCellStyles altova:nColSpan="1">
							<xsl:text>\clvertalt</xsl:text>
							<xsl:element name="altova:TableCellColor">
								<xsl:attribute name="altova:sValue" select="'#F0F0F0'"/>
						...
						<xsl:for-each select="n1:Element">
							<xsl:call-template name="BookmarkItem">
					...
					<altova:table-cell altova:is-body-cell="true" altova:paragraph-styles="\ql\sl0">
						...
						<xsl:for-each select="n1:ComplexType">
							<xsl:call-template name="BookmarkItem">
								<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
							</xsl:call-template>
						</xsl:for-each>
					...
					<altova:table-cell altova:is-body-cell="true" altova:paragraph-styles="\ql\sl0">
						...
						<xsl:for-each select="n1:SimpleType">
							<xsl:call-template name="BookmarkItem">
								<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
							</xsl:call-template>
						</xsl:for-each>
					...
					<altova:table-cell altova:is-body-cell="true" altova:paragraph-styles="\ql\sl0">
						...
						<xsl:for-each select="n1:AttributeGroup">
							<xsl:call-template name="BookmarkItem">
								<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
							</xsl:call-template>
						</xsl:for-each>
					...
					<altova:table-cell altova:is-body-cell="true" altova:paragraph-styles="\ql\sl0">
						...
						<xsl:for-each select="n1:Notation">
							<xsl:call-template name="BookmarkItem">
								<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
							</xsl:call-template>
						</xsl:for-each>
	...
	<xsl:template name="XMLSource">
		<xsl:param name="templatetablelevel" select="0"/>
		<xsl:param name="InMixed" as="xs:boolean?" select="false()"/>
		<altova:text-block altova:selector=".textOperator" altova:character-styles="\cf5\f1\fs20" altova:character-reset-styles="\cf0\f0\fs24">
			<xsl:text>\u60?</xsl:text>
		</altova:text-block>
		<altova:text-block altova:selector=".textElement" altova:character-styles="\cf6\f1\fs20" altova:character-reset-styles="\cf0\f0\fs24">
			<altova:string-to-unicode>
		...
		<xsl:for-each select="@*">
			<xsl:if test="not(starts-with(name(),&apos;xsi:&apos;))">
				<altova:text-block altova:character-styles="\fs20" altova:character-reset-styles="\fs24">
					<xsl:text>\u32?\u32?</xsl:text>
				</altova:text-block>
				<altova:text-block altova:selector=".textAttr" altova:character-styles="\cf7\f1\fs20" altova:character-reset-styles="\cf0\f0\fs24">
					<altova:string-to-unicode>
						<xsl:value-of select="./name()"/>
					</altova:string-to-unicode>
				</altova:text-block>
				<altova:text-block altova:selector=".textOperator" altova:character-styles="\cf5\f1\fs20" altova:character-reset-styles="\cf0\f0\fs24">
					<xsl:text>\u61?\u34?</xsl:text>
				</altova:text-block>
				<altova:text-block altova:selector=".textContents" altova:character-styles="\cf3\f1\fs20" altova:character-reset-styles="\cf0\f0\fs24">
					<xsl:choose>
						<xsl:when test=". instance of element() or . instance of document-node()">
							<xsl:apply-templates>
								<xsl:with-param name="altova:nMaxWidthIn" select="7.30556" as="xs:double"/>
							</xsl:apply-templates>
						</xsl:when>
						<xsl:otherwise>
							<altova:string-to-unicode>
				...
				<altova:text-block altova:selector=".textOperator" altova:character-styles="\cf5\f1\fs20" altova:character-reset-styles="\cf0\f0\fs24">
					<xsl:text>\u34?</xsl:text>
				</altova:text-block>
			</xsl:if>
		</xsl:for-each>
		<xsl:choose>
			<xsl:when test="( exists(*) and exists(text()) ) or $InMixed">
				<altova:text-block altova:selector=".textOperator" altova:character-styles="\cf5\f1\fs20" altova:character-reset-styles="\cf0\f0\fs24">
					<xsl:text>\u62?</xsl:text>
				</altova:text-block>
				<xsl:for-each select="* | text()">
					<xsl:choose>
						<xsl:when test=".instance of element()">
							<xsl:call-template name="XMLSource">
								<xsl:with-param name="InMixed" select="true()"/>
								<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
							</xsl:call-template>
						</xsl:when>
						<xsl:otherwise>
			...
			<xsl:when test="exists(*)">
				...
				<xsl:for-each select="*">
					...
					<altova:table>
						<xsl:variable name="altova:ColumnData"/>
						<altova:TableGrid>
							<altova:GridCol altova:sWidth="2" altova:sType="percent"/>
							<altova:GridCol altova:sWidth="98" altova:sType="percent"/>
						</altova:TableGrid>
						<altova:TableStyles altova:nBorderSpacingPt="0.00" altova:sBorderCollapse="separate" altova:nCellPaddingPt="0.00" altova:nLeftMarginPt="0.00">
							<xsl:text>\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil</xsl:text>
			...
			<xsl:otherwise>
				<altova:text-block altova:selector=".textOperator" altova:character-styles="\cf5\f1\fs20" altova:character-reset-styles="\cf0\f0\fs24">
					<xsl:text>\u47?\u62?</xsl:text>
				</altova:text-block>
			</xsl:otherwise>
		</xsl:choose>
	</xsl:template>
	<xsl:template name="PropertyTable">
		<xsl:param name="templatetablelevel" select="0"/>
		...
		<altova:table>
			<xsl:variable name="altova:ColumnData"/>
			<altova:TableGrid>
				<altova:GridCol altova:sWidth="1152" altova:sType="twips"/>
				<altova:GridCol altova:sWidth="90" altova:sType="percent"/>
			</altova:TableGrid>
			<altova:TableStyles altova:nBorderSpacingPt="0.00" altova:sBorderCollapse="separate" altova:nCellPaddingPt="3.75" altova:nLeftMarginPt="0.00">
				<xsl:text>\trbrdrt\brdroutset\brdrcf8\brdrw15\trbrdrl\brdroutset\brdrcf8\brdrw15\trbrdrb\brdroutset\brdrcf8\brdrw15\trbrdrr\brdroutset\brdrcf8\brdrw15</xsl:text>
				<altova:Borders>
				...
				<altova:table-row>
					...
					<altova:table-cell altova:paragraph-styles="\qr\sl0">
						<altova:TableCellStyles altova:nColSpan="1">
							<xsl:text>\clvertalt</xsl:text>
							<xsl:element name="altova:TableCellColor">
								<xsl:attribute name="altova:sValue" select="$backgroundColor"/>
							</xsl:element>
							<altova:Borders>
								<altova:Top>
									<xsl:text>\clbrdrt</xsl:text>
									<xsl:text>\brdrs</xsl:text>
									<xsl:text>\brdrcf9</xsl:text>
									<xsl:element name="altova:BorderWidthPt">
										<xsl:attribute name="altova:nWidthPt" select="0.75"/>
									</xsl:element>
								</altova:Top>
								<altova:Bottom>
									<xsl:text>\clbrdrb</xsl:text>
									<xsl:text>\brdrs</xsl:text>
									<xsl:text>\brdrcf10</xsl:text>
									<xsl:element name="altova:BorderWidthPt">
										<xsl:attribute name="altova:nWidthPt" select="0.75"/>
									</xsl:element>
								</altova:Bottom>
						...
						<altova:new-line/>
						<altova:text-block altova:character-styles="\fs20\i" altova:character-reset-styles="\fs24\i0">
							<xsl:text>\u68?</xsl:text>
						</altova:text-block>
						<altova:text-block altova:selector=".schemaSubTitle" altova:character-styles="\cf4\f4\fs20\i" altova:character-reset-styles="\cf0\f0\fs24\i0">
							<xsl:text>\u105?\u97?\u103?\u114?\u97?\u109?</xsl:text>
						</altova:text-block>
					</altova:table-cell>
					<altova:table-cell altova:paragraph-styles="\ql\sl0">
						<altova:TableCellStyles altova:nColSpan="1">
							<xsl:text>\clvertalt</xsl:text>
							<xsl:element name="altova:TableCellColor">
								<xsl:attribute name="altova:sValue" select="'white'"/>
							</xsl:element>
							<altova:Borders>
								<altova:Top>
									<xsl:text>\clbrdrt</xsl:text>
						...
						<altova:image altova:width="{concat(@width,'px')}" altova:height="{concat(@height,'px')}" altova:SrcUrl="{@src}"/>
					</altova:table-cell>
				</altova:table-row>
			</xsl:for-each>
			<xsl:for-each select="n1:Annotations">
				<altova:table-row>
					<xsl:element name="altova:TableRowStyles">
						<xsl:text>\trrh0</xsl:text>
					</xsl:element>
					<altova:table-cell altova:paragraph-styles="\qr\sl0">
						...
						<altova:text-block altova:character-styles="\fs20\i" altova:character-reset-styles="\fs24\i0">
							<xsl:text>\u68?\u97?\u116?\u97?\u32?\u68?\u101?\u102?\u105?\u110?\u105?\u116?\u105?\u111?\u110?</xsl:text>
						</altova:text-block>
					</altova:table-cell>
					<altova:table-cell altova:paragraph-styles="\ql\sl0">
						<altova:TableCellStyles altova:nColSpan="1">
						...
						<xsl:for-each select="n1:Annotation">
							<altova:text-block>
								<xsl:apply-templates/>
							</altova:text-block>
						</xsl:for-each>
			...
			<xsl:for-each select="n1:Properties">
				<altova:table-row>
					<xsl:element name="altova:TableRowStyles">
						<xsl:text>\trrh0</xsl:text>
					</xsl:element>
					<altova:table-cell altova:paragraph-styles="\qr\sl0">
						...
						<altova:text-block altova:character-styles="\fs20\i" altova:character-reset-styles="\fs24\i0">
							<xsl:text>\u83?\u99?\u104?\u101?\u109?\u97?\u32?\u85?\u115?\u101?</xsl:text>
						</altova:text-block>
					</altova:table-cell>
					<altova:table-cell altova:paragraph-styles="\sl0">
						<altova:TableCellStyles altova:nColSpan="1">
						...
						<xsl:choose>
							<xsl:when test="not(exists(n1:Property[@name=&apos;minOcc&apos;]))">
								<altova:text-block>
									<xsl:text>\u82?\u101?\u113?\u117?\u105?\u114?\u101?\u100?</xsl:text>
								</altova:text-block>
							</xsl:when>
							<xsl:when test="n1:Property[@name=&apos;minOcc&apos;]/text()=&apos;1&apos;">
								<altova:text-block>
									<xsl:text>\u82?\u101?\u113?\u117?\u105?\u114?\u101?\u100?</xsl:text>
								</altova:text-block>
							</xsl:when>
							<xsl:when test="n1:Property[@name=&apos;minOcc&apos;]/text()=&apos;0&apos;">
								<altova:text-block>
									<xsl:text>\u79?\u112?\u116?\u105?\u111?\u110?\u97?\u108?</xsl:text>
								</altova:text-block>
							</xsl:when>
						</xsl:choose>
						<xsl:if test="exists(n1:Property[@name=&apos;maxOcc&apos; ])and (n1:Property[@name=&apos;maxOcc&apos;]/text()=&apos;unbounded&apos; or n1:Property[@name=&apos;maxOcc&apos;]/text()!=&apos;1&apos;)">
							<altova:text-block>
								<xsl:text>\u59?\u32?\u82?\u101?\u112?\u101?\u97?\u116?\u97?\u98?\u108?\u101?</xsl:text>
							</altova:text-block>
						</xsl:if>
					</altova:table-cell>
				</altova:table-row>
			...
			<xsl:for-each select="n1:Properties">
				<altova:table-row>
					...
					<altova:table-cell altova:paragraph-styles="\sl0">
						...
						<altova:text-block altova:character-styles="\fs20\i" altova:character-reset-styles="\fs24\i0">
							<xsl:text>\u82?\u101?\u99?\u111?\u109?\u109?\u101?\u110?\u100?\u101?\u100?\u32?\u85?\u115?\u101?</xsl:text>
						</altova:text-block>
					</altova:table-cell>
					<altova:table-cell altova:paragraph-styles="\sl0">
						<altova:TableCellStyles altova:nColSpan="1">
			...
			<xsl:for-each select="n1:Namespace">
				<altova:table-row>
					<xsl:element name="altova:TableRowStyles">
						<xsl:text>\trrh0</xsl:text>
					</xsl:element>
					...
					<altova:table-cell altova:paragraph-styles="\ql\sl0">
						...
						<altova:text-block altova:selector=".schemaSubData" altova:character-styles="\cf3\f1\fs20\i0" altova:character-reset-styles="\cf0\f0\fs24">
							<xsl:apply-templates/>
						</altova:text-block>
					</altova:table-cell>
				</altova:table-row>
			...
			<xsl:for-each select="n1:TypeAlternatives">
				<altova:table-row>
					<xsl:element name="altova:TableRowStyles">
						<xsl:text>\trrh0</xsl:text>
					</xsl:element>
					<altova:table-cell altova:paragraph-styles="\qr\sl0">
						...
						<altova:text-block altova:character-styles="\fs20\i" altova:character-reset-styles="\fs24\i0">
							<xsl:text>\u84?\u121?\u112?\u101?\u32?\u65?\u108?\u116?\u101?\u114?\u110?\u97?\u116?\u105?\u118?\u101?\u115?</xsl:text>
						</altova:text-block>
					</altova:table-cell>
					<altova:table-cell altova:paragraph-styles="\sl0">
						<altova:TableCellStyles altova:nColSpan="1">
						...
						<altova:table>
							...
							<altova:table-row>
								...
								<altova:table-cell altova:paragraph-styles="\sl0">
									...
									<altova:text-block altova:selector=".schemaSubTitle" altova:character-styles="\cf4\f1\fs16\i" altova:character-reset-styles="\cf0\f0\fs24\i0">
										<xsl:text>\u84?\u101?\u115?\u116?</xsl:text>
									</altova:text-block>
								</altova:table-cell>
								<altova:table-cell altova:paragraph-styles="\sl0">
									<altova:TableCellStyles altova:nColSpan="1">
								...
								<altova:table-cell altova:paragraph-styles="\sl0">
									...
									<altova:text-block altova:selector=".schemaSubTitle" altova:character-styles="\cf4\f1\fs16\i" altova:character-reset-styles="\cf0\f0\fs24\i0">
										<xsl:text>\u88?\u80?\u97?\u116?\u104?\u68?\u101?\u102?\u97?\u117?\u108?\u116?\u78?\u115?</xsl:text>
									</altova:text-block>
								</altova:table-cell>
								<altova:table-cell altova:paragraph-styles="\sl0">
									<altova:TableCellStyles altova:nColSpan="1">
							...
							<xsl:for-each select="n1:TypeAlternative">
								<altova:table-row>
									<xsl:element name="altova:TableRowStyles">
										<xsl:text>\trrh0</xsl:text>
									</xsl:element>
									<altova:table-cell altova:paragraph-styles="\ql\sl0">
										...
										<xsl:for-each select="@test">
											<altova:text-block altova:selector=".schemaSubData" altova:character-styles="\cf3\f1\fs20\i" altova:character-reset-styles="\cf0\f0\fs24\i0">
												<altova:string-to-unicode>
													<xsl:value-of select="string(.)"/>
												</altova:string-to-unicode>
											</altova:text-block>
			...
			<xsl:for-each select="n1:SubstitutionGroups">
				<altova:table-row>
					<xsl:element name="altova:TableRowStyles">
						<xsl:text>\trrh0</xsl:text>
					</xsl:element>
					<altova:table-cell altova:paragraph-styles="\qr\sl0">
						...
						<altova:text-block altova:character-styles="\fs20\i" altova:character-reset-styles="\fs24\i0">
							<xsl:text>\u83?\u117?\u98?\u115?\u116?\u105?\u116?\u117?\u116?\u105?\u111?\u110?\u32?\u71?\u114?\u111?\u117?\u112?</xsl:text>
						</altova:text-block>
					</altova:table-cell>
					<altova:table-cell altova:paragraph-styles="\sl0">
						<altova:TableCellStyles altova:nColSpan="1">
						...
						<xsl:for-each select="n1:SubstitutionGroup">
							<xsl:call-template name="RefContentList1">
								<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
							</xsl:call-template>
						</xsl:for-each>
					</altova:table-cell>
			...
			<xsl:for-each select="n1:Properties">
				<altova:table-row>
					...
					<altova:table-cell altova:paragraph-styles="\qr\sl0">
						...
						<altova:text-block altova:character-styles="\fs20\i" altova:character-reset-styles="\fs24\i0">
							<xsl:text>\u80?\u114?\u111?\u112?\u101?\u114?\u116?\u105?\u101?\u115?</xsl:text>
						</altova:text-block>
					</altova:table-cell>
					<altova:table-cell altova:paragraph-styles="\ql\sl0">
						<altova:TableCellStyles altova:nColSpan="1">
							...
							<altova:table-row>
								...
								<altova:table-cell altova:paragraph-styles="\sl0">
									...
									<altova:table>
										<xsl:variable name="altova:ColumnData"/>
										<altova:TableGrid>
											<altova:GridCol altova:sWidth="13" altova:sType="percent"/>
											<altova:GridCol altova:sWidth="1" altova:sType="percent"/>
											<altova:GridCol altova:sWidth="86" altova:sType="percent"/>
										</altova:TableGrid>
										<altova:TableStyles altova:nBorderSpacingPt="0.00" altova:sBorderCollapse="separate" altova:nCellPaddingPt="0.00" altova:nLeftMarginPt="0.00">
											<xsl:text>\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil</xsl:text>
											<altova:TableWidth altova:sWidth="{'100%'}"/>
										</altova:TableStyles>
										<xsl:for-each select="n1:Property">
											<altova:table-row>
												<xsl:element name="altova:TableRowStyles">
													<xsl:text>\trrh0</xsl:text>
												</xsl:element>
			...
			<xsl:for-each select="n1:Children">
				<altova:table-row>
					<xsl:element name="altova:TableRowStyles">
						<xsl:text>\trrh0</xsl:text>
					</xsl:element>
					<altova:table-cell altova:paragraph-styles="\qr\sl0">
						...
						<altova:text-block altova:character-styles="\fs20\i" altova:character-reset-styles="\fs24\i0">
							<xsl:text>\u67?\u104?\u105?\u108?\u100?\u114?\u101?\u110?</xsl:text>
						</altova:text-block>
					</altova:table-cell>
					<altova:table-cell altova:paragraph-styles="\ql\sl0">
						<altova:TableCellStyles altova:nColSpan="1">
			...
			<xsl:for-each select="n1:UsedBy">
				<altova:table-row>
					...
					<altova:table-cell altova:paragraph-styles="\qr\sl0">
						...
						<altova:text-block altova:character-styles="\fs20\i" altova:character-reset-styles="\fs24\i0">
							<xsl:text>\u85?\u115?\u101?\u100?\u32?\u66?\u121?</xsl:text>
						</altova:text-block>
					</altova:table-cell>
					<altova:table-cell altova:paragraph-styles="\ql\sl0">
						<altova:TableCellStyles altova:nColSpan="1">
							...
							<altova:table-row>
								...
								<altova:table-cell altova:paragraph-styles="\sl0">
									...
									<altova:table>
										...
										<xsl:for-each-group group-by="@type" select="n1:By">
											<altova:table-row>
												<xsl:element name="altova:TableRowStyles">
													<xsl:text>\trrh0</xsl:text>
												</xsl:element>
			...
			<xsl:for-each select="n1:Facets[./n1:Facet/@kind=&apos;enumeration&apos;]">
				<altova:table-row>
					<xsl:element name="altova:TableRowStyles">
						<xsl:text>\trrh0</xsl:text>
					</xsl:element>
					<altova:table-cell altova:paragraph-styles="\sl0">
						...
						<altova:text-block altova:character-styles="\fs20\i" altova:character-reset-styles="\fs24\i0">
							<xsl:text>\u69?\u110?\u117?\u109?\u101?\u114?\u97?\u116?\u105?\u111?\u110?\u115?</xsl:text>
						</altova:text-block>
					</altova:table-cell>
					<altova:table-cell altova:paragraph-styles="\sl0">
						<altova:TableCellStyles altova:nColSpan="1">
						...
						<altova:table>
							<xsl:variable name="altova:ColumnData"/>
							<altova:TableGrid>
								<altova:GridCol altova:sWidth="3283" altova:sType="twips"/>
								<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
							</altova:TableGrid>
							...
							<altova:table-row>
								...
								<altova:table-cell altova:paragraph-styles="\sl0">
									...
									<altova:text-block altova:character-styles="\fs20\i0" altova:character-reset-styles="\fs24">
										<xsl:text>\u99?\u111?\u100?\u101?</xsl:text>
									</altova:text-block>
								</altova:table-cell>
								<altova:table-cell altova:paragraph-styles="\sl0">
									<altova:TableCellStyles altova:nColSpan="1">
									...
									<altova:text-block altova:character-styles="\fs20\i" altova:character-reset-styles="\fs24\i0">
										<xsl:text>\u100?\u101?\u115?\u99?\u114?\u105?\u112?\u116?\u105?\u111?\u110?</xsl:text>
									</altova:text-block>
								</altova:table-cell>
							</altova:table-row>
							<xsl:for-each select="n1:Facet[@kind=&apos;enumeration&apos;]">
								<altova:table-row>
									<xsl:element name="altova:TableRowStyles">
										<xsl:text>\trrh-389</xsl:text>
									</xsl:element>
									<altova:table-cell altova:paragraph-styles="\sl0">
										<altova:TableCellStyles altova:nColSpan="1">
											<xsl:text>\clvertalc</xsl:text>
			...
			<xsl:for-each select="n1:Facets[./n1:Facet/@kind != &apos;enumeration&apos;]">
				<altova:table-row>
					...
					<altova:table-cell altova:paragraph-styles="\qr\sl0">
						...
						<altova:text-block altova:character-styles="\fs20\i" altova:character-reset-styles="\fs24\i0">
							<xsl:text>\u70?\u97?\u99?\u101?\u116?\u115?</xsl:text>
						</altova:text-block>
					</altova:table-cell>
					<altova:table-cell altova:paragraph-styles="\ql\sl0">
						<altova:TableCellStyles altova:nColSpan="1">
						...
						<altova:table>
							...
							<altova:table-row>
								...
								<altova:table-cell altova:paragraph-styles="\ql\sl0">
									...
									<altova:text-block altova:selector=".schemaSubTitle" altova:character-styles="\cf4\f1\fs16\i" altova:character-reset-styles="\cf0\f0\fs24\i0">
										<xsl:text>\u75?\u105?\u110?\u100?</xsl:text>
									</altova:text-block>
								</altova:table-cell>
								<altova:table-cell altova:paragraph-styles="\sl0">
									<altova:TableCellStyles altova:nColSpan="1">
							...
							<xsl:for-each select="n1:Facet[@kind != &apos;enumeration&apos;]">
								<altova:table-row>
									...
									<altova:table-cell altova:paragraph-styles="\ql\sl0">
										...
										<xsl:for-each select="@value">
											<xsl:call-template name="RefContent_FontSubData">
												<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 2"/>
											</xsl:call-template>
										</xsl:for-each>
									</altova:table-cell>
			...
			<xsl:for-each select="n1:Assertions">
				<altova:table-row>
					<xsl:element name="altova:TableRowStyles">
						<xsl:text>\trrh0</xsl:text>
					</xsl:element>
					<altova:table-cell altova:paragraph-styles="\qr\sl0">
						...
						<altova:text-block altova:character-styles="\fs20\i" altova:character-reset-styles="\fs24\i0">
							<xsl:text>\u65?\u115?\u115?\u101?\u114?\u116?\u105?\u111?\u110?\u115?</xsl:text>
						</altova:text-block>
					</altova:table-cell>
					<altova:table-cell altova:paragraph-styles="\sl0">
						<altova:TableCellStyles altova:nColSpan="1">
						...
						<altova:table>
							...
							<xsl:for-each select="n1:Assertion">
								<altova:table-row>
									<xsl:element name="altova:TableRowStyles">
										<xsl:text>\trrh0</xsl:text>
									</xsl:element>
			...
			<xsl:for-each select="n1:LocalAttributes">
				<altova:table-row>
					<xsl:element name="altova:TableRowStyles">
						<xsl:text>\trrh0</xsl:text>
					</xsl:element>
						...
						<altova:table>
							...
							<altova:table-row>
								...
								<altova:table-cell altova:paragraph-styles="\sl0">
									...
									<altova:text-block altova:selector=".schemaSubTitle" altova:character-styles="\cf4\f1\fs16\i" altova:character-reset-styles="\cf0\f0\fs24\i0">
										<xsl:text>\u85?\u115?\u101?</xsl:text>
									</altova:text-block>
								</altova:table-cell>
								<altova:table-cell altova:paragraph-styles="\sl0">
									<altova:TableCellStyles altova:nColSpan="1">
								...
								<altova:table-cell altova:paragraph-styles="\sl0">
									...
									<altova:text-block altova:selector=".schemaSubTitle" altova:character-styles="\cf4\f1\fs16\i" altova:character-reset-styles="\cf0\f0\fs24\i0">
										<xsl:text>\u68?\u101?\u102?\u97?\u117?\u108?\u116?</xsl:text>
									</altova:text-block>
								</altova:table-cell>
								<altova:table-cell altova:paragraph-styles="\sl0">
									<altova:TableCellStyles altova:nColSpan="1">
								...
								<altova:table-cell altova:paragraph-styles="\sl0">
									...
									<altova:text-block altova:selector=".schemaSubTitle" altova:character-styles="\cf4\f1\fs16\i" altova:character-reset-styles="\cf0\f0\fs24\i0">
										<xsl:text>\u70?\u105?\u120?\u101?\u100?</xsl:text>
									</altova:text-block>
								</altova:table-cell>
								<altova:table-cell altova:paragraph-styles="\sl0">
									<altova:TableCellStyles altova:nColSpan="1">
							...
							<xsl:for-each select="n1:LocalAttribute">
								<altova:table-row>
									<xsl:element name="altova:TableRowStyles">
										<xsl:text>\trrh0</xsl:text>
									</xsl:element>
			...
			<xsl:for-each select="n1:Asserts">
				<altova:table-row>
					<xsl:element name="altova:TableRowStyles">
						<xsl:text>\trrh0</xsl:text>
					</xsl:element>
					<altova:table-cell altova:paragraph-styles="\qr\sl0">
						...
						<altova:text-block altova:character-styles="\fs20\i" altova:character-reset-styles="\fs24\i0">
							<xsl:text>\u65?\u115?\u115?\u101?\u114?\u116?\u115?</xsl:text>
						</altova:text-block>
					</altova:table-cell>
					<altova:table-cell altova:paragraph-styles="\sl0">
						<altova:TableCellStyles altova:nColSpan="1">
			...
			<xsl:for-each select="n1:IdentityConstraints">
				<altova:table-row>
					<xsl:element name="altova:TableRowStyles">
						<xsl:text>\trrh0</xsl:text>
					</xsl:element>
					<altova:table-cell altova:paragraph-styles="\qr\sl0">
						...
						<altova:text-block altova:character-styles="\fs20\i" altova:character-reset-styles="\fs24\i0">
							<xsl:text>\u73?\u100?\u101?\u110?\u116?\u105?\u116?\u121?\u32?\u67?\u111?\u110?\u115?\u116?\u114?\u97?\u105?\u110?\u116?\u115?</xsl:text>
						</altova:text-block>
					</altova:table-cell>
					<altova:table-cell altova:paragraph-styles="\ql\sl0">
						<altova:TableCellStyles altova:nColSpan="1">
						...
						<altova:table>
							...
							<altova:table-row>
								...
								<altova:table-cell altova:character-styles="\cf3\f1\fs16" altova:character-reset-styles="\cf0\f0\fs24" altova:paragraph-styles="\sl0">
									<altova:TableCellStyles altova:nColSpan="1">
										<xsl:text>\clvertalc</xsl:text>
									</altova:TableCellStyles>
								</altova:table-cell>
								...
								<altova:table-cell altova:character-styles="\cf3\f1\fs16" altova:character-reset-styles="\cf0\f0\fs24" altova:paragraph-styles="\sl0">
									...
									<altova:text-block altova:selector=".schemaSubTitle" altova:character-styles="\cf4\f1\fs16\i" altova:character-reset-styles="\cf0\f0\fs24\i0">
										<xsl:text>\u82?\u101?\u102?\u101?\u114?</xsl:text>
									</altova:text-block>
								</altova:table-cell>
								<altova:table-cell altova:character-styles="\cf3\f1\fs16" altova:character-reset-styles="\cf0\f0\fs24" altova:paragraph-styles="\sl0">
									<altova:TableCellStyles altova:nColSpan="1">
								...
								<altova:table-cell altova:character-styles="\cf3\f1\fs16" altova:character-reset-styles="\cf0\f0\fs24" altova:paragraph-styles="\sl0">
									...
									<altova:text-block altova:selector=".schemaSubTitle" altova:character-styles="\cf4\f1\fs16\i" altova:character-reset-styles="\cf0\f0\fs24\i0">
										<xsl:text>\u83?\u101?\u108?\u101?\u99?\u116?\u111?\u114?</xsl:text>
									</altova:text-block>
								</altova:table-cell>
								<altova:table-cell altova:character-styles="\cf3\f1\fs16" altova:character-reset-styles="\cf0\f0\fs24" altova:paragraph-styles="\sl0">
									<altova:TableCellStyles altova:nColSpan="1">
								...
								<altova:table-cell altova:character-styles="\cf3\f1\fs16" altova:character-reset-styles="\cf0\f0\fs24" altova:paragraph-styles="\sl0">
									...
									<altova:text-block altova:selector=".schemaSubTitle" altova:character-styles="\cf4\f1\fs16\i" altova:character-reset-styles="\cf0\f0\fs24\i0">
										<xsl:text>\u70?\u105?\u101?\u108?\u100?\u40?\u115?\u41?</xsl:text>
									</altova:text-block>
								</altova:table-cell>
								<altova:table-cell altova:character-styles="\cf3\f1\fs16" altova:character-reset-styles="\cf0\f0\fs24" altova:paragraph-styles="\sl0">
									<altova:TableCellStyles altova:nColSpan="1">
							...
							<xsl:for-each select="n1:Constraint">
								<altova:table-row>
									<xsl:element name="altova:TableRowStyles">
										<xsl:text>\trrh0</xsl:text>
									</xsl:element>
									<altova:table-cell altova:character-styles="\cf3\f1\fs16" altova:character-reset-styles="\cf0\f0\fs24" altova:paragraph-styles="\ql\sl0">
										<altova:TableCellStyles altova:nColSpan="1">
											<xsl:text>\clvertalt</xsl:text>
										</altova:TableCellStyles>
										<xsl:for-each select="@kind">
									...
									<altova:table-cell altova:character-styles="\cf3\f1\fs16" altova:character-reset-styles="\cf0\f0\fs24" altova:paragraph-styles="\ql\sl0">
										...
										<xsl:choose>
											<xsl:when test="@refer_ref">
												<altova:link altova:Dest="{concat(&apos;#&apos;,@refer_ref)}">
									...
									<altova:table-cell altova:character-styles="\cf3\f1\fs16" altova:character-reset-styles="\cf0\f0\fs24" altova:paragraph-styles="\ql\sl0">
										...
										<xsl:for-each select="n1:Field">
											<altova:paragraph altova:selector="div.schemaSubData" altova:character-styles="\cf3\f1\fs16\f0\fs24" altova:character-reset-styles="\cf0\f0\fs24" altova:paragraph-styles="\sl0" altova:is-div="true">
												<altova:text-block altova:selector=".schemaSubData" altova:character-styles="\cf3\f1\fs16" altova:character-reset-styles="\cf0\f0\fs24">
													<xsl:apply-templates/>
												</altova:text-block>
											</altova:paragraph>
			...
			<xsl:for-each select="n1:Source">
				<altova:table-row>
					...
					<altova:table-cell altova:paragraph-styles="\qr\sl0">
						...
						<altova:text-block altova:character-styles="\fs20\i" altova:character-reset-styles="\fs24\i0">
							<xsl:text>\u83?\u111?\u117?\u114?\u99?\u101?</xsl:text>
						</altova:text-block>
					</altova:table-cell>
					<altova:table-cell altova:paragraph-styles="\ql\sl0">
						<altova:TableCellStyles altova:nColSpan="1">
	...
	<xsl:template name="BookmarkItem">
		<xsl:param name="templatetablelevel" select="0"/>
		<altova:paragraph altova:selector="div.schemaName" altova:character-styles="\cf3\f1\fs16\b\f0\fs24" altova:character-reset-styles="\cf0\f0\fs24\b0" altova:paragraph-styles="\sl0" altova:is-div="true">
			<altova:link altova:Dest="{concat(&apos;#&apos;,@id)}">
				<xsl:for-each select="@name">
					<altova:text-block altova:selector=".schemaName" altova:character-styles="\cf3\f1\fs16\b" altova:character-reset-styles="\cf0\f0\fs24\b0">
						<altova:string-to-unicode>
							<xsl:value-of select="string(.)"/>
			...
			<xsl:choose>
				<xsl:when test="@redefinition">
					<altova:text-block altova:selector=".schemaSubTitle" altova:character-styles="\cf4\f1\fs16\i" altova:character-reset-styles="\cf0\f0\fs24\i0">
						<xsl:text>\u32?\u40?\u114?\u41?</xsl:text>
					</altova:text-block>
				</xsl:when>
				<xsl:when test="@override">
					<altova:text-block altova:selector=".schemaSubTitle" altova:character-styles="\cf4\f1\fs16\i" altova:character-reset-styles="\cf0\f0\fs24\i0">
						<xsl:text>\u32?\u40?\u111?\u41?</xsl:text>
					</altova:text-block>
				</xsl:when>
			</xsl:choose>
		</altova:paragraph>
	</xsl:template>
	<xsl:template name="SchemaItem">
		<xsl:param name="templatetablelevel" select="0"/>
		<xsl:param name="type" as="xs:string" select="&apos;&apos;"/>
		<xsl:param name="backgroundColor" as="xs:string" select="&apos;&apos;"/>
		<altova:paragraph altova:selector="div" altova:character-styles="\f0\fs24" altova:paragraph-styles="\keepn\sl0" altova:is-div="true">
			<altova:bookmark name="{@id}">
				<xsl:choose>
					<xsl:when test="xs:boolean(@redefinition)">
						<altova:text-block altova:selector=".elementHeader" altova:character-styles="\cf3\f1\fs20" altova:character-reset-styles="\cf0\f0\fs24">
							<xsl:text>\u114?\u101?\u100?\u101?\u102?\u105?\u110?\u105?\u116?\u105?\u111?\u110?\u32?\u111?\u102?\u32?</xsl:text>
						</altova:text-block>
					</xsl:when>
					<xsl:when test="xs:boolean(@override)">
						<altova:text-block altova:selector=".elementHeader" altova:character-styles="\cf3\f1\fs20" altova:character-reset-styles="\cf0\f0\fs24">
							<xsl:text>\u111?\u118?\u101?\u114?\u114?\u105?\u100?\u101?\u32?\u111?\u102?\u32?</xsl:text>
						</altova:text-block>
					</xsl:when>
				</xsl:choose>
				...
				<xsl:for-each select="@name">
					<xsl:call-template name="RefContent_FontElementHeader2">
						<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
					</xsl:call-template>
				</xsl:for-each>
			</altova:bookmark>
		</altova:paragraph>
		<xsl:call-template name="PropertyTable">
			<xsl:with-param name="backgroundColor" select="$backgroundColor"/>
			<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
		</xsl:call-template>
		<altova:new-line/>
		<xsl:for-each select="(n1:Attribute|n1:Element)">
			<xsl:apply-templates select="current()">
				<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
			</xsl:apply-templates>
		</xsl:for-each>
	...
	<xsl:template name="Footer">
		<xsl:param name="templatetablelevel" select="0"/>
		<altova:paragraph altova:selector="div.schemaSubTitle" altova:character-styles="\cf4\f1\fs16\i\f0\fs24" altova:character-reset-styles="\cf0\f0\fs24\i0" altova:paragraph-styles="\sl0" altova:is-div="true">
			<altova:text-block altova:selector=".schemaSubTitle" altova:character-styles="\cf4\f1\fs16\i" altova:character-reset-styles="\cf0\f0\fs24\i0">
				<xsl:text>\u88?\u77?\u76?\u32?\u83?\u99?\u104?\u101?\u109?\u97?\u32?\u100?\u111?\u99?\u117?\u109?\u101?\u110?\u116?\u97?\u116?\u105?\u111?\u110?\u32?\u103?\u101?\u110?\u101?\u114?\u97?\u116?\u101?\u100?\u32?\u98?\u121?\u32?</xsl:text>
			</altova:text-block>
			<altova:link altova:Dest="{&apos;http://www.altova.com/xmlspy&apos;}">
				<altova:text-block altova:selector=".schemaName" altova:character-styles="\cf3\f1\fs16\b" altova:character-reset-styles="\cf0\f0\fs24\b0">
					<xsl:text>\u88?\u77?\u76?\u83?\u112?\u121?</xsl:text>
				</altova:text-block>
			</altova:link>
			<altova:text-block altova:selector=".schemaSubTitle" altova:character-styles="\cf4\f1\fs16\i" altova:character-reset-styles="\cf0\f0\fs24\i0">
				<xsl:text>\u32?\u83?\u99?\u104?\u101?\u109?\u97?\u32?\u69?\u100?\u105?\u116?\u111?\u114?\u32?</xsl:text>
			</altova:text-block>
			<altova:link altova:Dest="{&apos;http://www.altova.com/xmlspy&apos;}">
				<altova:text-block altova:selector=".schemaName" altova:character-styles="\cf3\f1\fs16\b" altova:character-reset-styles="\cf0\f0\fs24\b0">
					<xsl:text>\u104?\u116?\u116?\u112?\u58?\u47?\u47?\u119?\u119?\u119?\u46?\u97?\u108?\u116?\u111?\u118?\u97?\u46?\u99?\u111?\u109?\u47?\u120?\u109?\u108?\u115?\u112?\u121?</xsl:text>
				</altova:text-block>
			</altova:link>
		</altova:paragraph>
	</xsl:template>
	<xsl:template name="RefContent_FontName">
		<xsl:param name="templatetablelevel" select="0"/>
		<xsl:choose>
			<xsl:when test="if (self::attribute()) then ../@ref else @ref">
				<altova:link altova:Dest="{concat(&apos;#&apos;,if (self::attribute()) then ../@ref else @ref)}">
					<altova:text-block altova:selector=".schemaName" altova:character-styles="\cf3\f1\fs16\b" altova:character-reset-styles="\cf0\f0\fs24\b0">
						<xsl:choose>
							<xsl:when test=". instance of element()">
								<xsl:apply-templates/>
	...
	<xsl:template name="RefContent_FontSubTitle">
		<xsl:param name="templatetablelevel" select="0"/>
		<xsl:choose>
			<xsl:when test="if (self::attribute()) then ../@ref else @ref">
				<altova:link altova:Dest="{concat(&apos;#&apos;,if (self::attribute()) then ../@ref else @ref)}">
	...
	<xsl:template name="RefContent_FontElementHeader2">
		<xsl:param name="templatetablelevel" select="0"/>
		<xsl:choose>
			<xsl:when test="if (self::attribute()) then ../@ref else @ref">
				<altova:link altova:Dest="{concat(&apos;#&apos;,if (self::attribute()) then ../@ref else @ref)}">
					<altova:text-block altova:selector=".elementHeader2" altova:character-styles="\cf3\f1\fs20\b" altova:character-reset-styles="\cf0\f0\fs24\b0">
						<xsl:choose>
							<xsl:when test=". instance of element()">
								<xsl:apply-templates/>
							</xsl:when>
	...
	<xsl:template name="RefContentList1">
		<xsl:param name="templatetablelevel" select="0"/>
	...
	<xsl:template name="RefContent_FontSubData">
		<xsl:param name="templatetablelevel" select="0"/>
		<xsl:choose>
			<xsl:when test="if (self::attribute()) then ../@ref else @ref">
				<altova:link altova:Dest="{concat(&apos;#&apos;,if (self::attribute()) then ../@ref else @ref)}">
	...
	<xsl:template name="Template1">
		...
		<xsl:choose>
			...
			<xsl:when test="n1:Property[@name=&apos;minOcc&apos;]/text()=&apos;1&apos;">
				<altova:text-block>
					<xsl:text>\u82?\u101?\u113?\u117?\u105?\u114?\u101?\u100?\u32?\u69?\u120?\u112?\u108?\u105?\u99?\u105?\u116?</xsl:text>
				</altova:text-block>
			</xsl:when>
			<xsl:when test="n1:Property[@name=&apos;minOcc&apos;]/text()=&apos;0&apos;">
				<altova:text-block>
	...
	<xsl:template name="altova:Section_1_FooterRight">
		<xsl:variable name="templatetablelevel" select="0"/>
		<xsl:call-template name="Footer">
			<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
		</xsl:call-template>
	</xsl:template>
	<xsl:template name="altova:Section_1_FooterLeft">
		<xsl:variable name="templatetablelevel" select="0"/>
		<xsl:call-template name="Footer">
			<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
		</xsl:call-template>
	...
	<xsl:variable name="altova:non-xpath-fonts-in-use" select="('Times New Roman','Arial','Symbol','Wingdings','inherit')"/>
	<xsl:variable name="altova:non-xpath-colors-in-use" select="('BLUE','GRAY','#000000','BLACK','#0000FF','#800000','#FF0000','#AAAAAA','#ACA899','#ECE9D8')"/>
	<xsl:variable name="altova:paragraph-style-selectors-in-use" select="('p','div','address','center','blockquote','fieldset','pre','pre-wrap','h1','h2','h3','h4','h5','h6','div.schemaSubData','div.schemaName','div.schemaSubTitle')"/>
	<xsl:variable name="altova:character-style-selectors-in-use" select="('.schemaHeader','.schemaHeader2','.schemaName','.schemaSubData','.schemaSubTitle','.textOperator','.textElement','.textAttr','.textContents','.elementHeader','.elementHeader2')"/>
	<xsl:variable name="altova:table-style-selectors-in-use" select="()"/>
	<xsl:variable name="altova:nodeCssClasses">
		<Class sFile="" sSelector="elementHeader" sRtfControlWordsChar="\cf3\f1\fs20" sRtfControlWordsPara="\sl0"/>
		<Class sFile="" sSelector="elementHeader2" sRtfControlWordsChar="\cf3\f1\fs20\b" sRtfControlWordsPara="\sl0"/>
		<Class sFile="" sSelector="schemaHeader" sRtfControlWordsChar="\cf3\f1\fs21" sRtfControlWordsPara="\sl0"/>
		<Class sFile="" sSelector="schemaHeader2" sRtfControlWordsChar="\cf3\f1\fs21\b" sRtfControlWordsPara="\sl0"/>
		<Class sFile="" sSelector="schemaName" sRtfControlWordsChar="\cf3\f1\fs16\b" sRtfControlWordsPara="\sl0"/>
		<Class sFile="" sSelector="schemaSubData" sRtfControlWordsChar="\cf3\f1\fs16" sRtfControlWordsPara="\sl0"/>
		<Class sFile="" sSelector="schemaSubTitle" sRtfControlWordsChar="\cf4\f1\fs16\i" sRtfControlWordsPara="\sl0"/>
		<Class sFile="" sSelector="table-border" sRtfControlWordsChar="\chbrdr\brdrs\brdrcf4\brdrw15" sRtfControlWordsPara="\sl0"/>
		<Class sFile="" sSelector="td-border" sRtfControlWordsChar="\chbrdr\brdrs\brdrcf4\brdrw15" sRtfControlWordsPara="\sl0"/>
		<Class sFile="" sSelector="textAttr" sRtfControlWordsChar="\cf7\f1\fs20" sRtfControlWordsPara="\sl0"/>
		<Class sFile="" sSelector="textContents" sRtfControlWordsChar="\cf3\f1\fs20" sRtfControlWordsPara="\sl0"/>
		<Class sFile="" sSelector="textElement" sRtfControlWordsChar="\cf6\f1\fs20" sRtfControlWordsPara="\sl0"/>
		<Class sFile="" sSelector="textOperator" sRtfControlWordsChar="\cf5\f1\fs20" sRtfControlWordsPara="\sl0"/>
	</xsl:variable>
	<xsl:template match="/">
		<xsl:for-each select="$altova:nodesAllSeparateDocuments">
			...
			<xsl:result-document href="{$altova:nodeDocument/@altova:Url}">
				...
				<xsl:text>{\s15\sl0\f0\fs24\cf3\f1\fs16\snext0 Paragraph schemaSubData;}</xsl:text>
				<xsl:text>{\s16\sl0\f0\fs24\cf3\f1\fs16\b\snext0 Paragraph schemaName;}</xsl:text>
				<xsl:text>{\s17\sl0\f0\fs24\cf4\f1\fs16\i\snext0 Paragraph schemaSubTitle;}</xsl:text>
				<xsl:text>{\*\cs18\cf3\f1\fs21\snext0 Character schemaHeader;}</xsl:text>
				<xsl:text>{\*\cs19\cf3\f1\fs21\b\snext0 Character schemaHeader2;}</xsl:text>
				<xsl:text>{\*\cs20\cf3\f1\fs16\i\b\snext0 Character schemaName;}</xsl:text>
				<xsl:text>{\*\cs21\cf3\f1\fs16\snext0 Character schemaSubData;}</xsl:text>
				<xsl:text>{\*\cs22\cf4\f1\fs16\i\snext0 Character schemaSubTitle;}</xsl:text>
				<xsl:text>{\*\cs23\cf5\f1\fs20\snext0 Character textOperator;}</xsl:text>
				<xsl:text>{\*\cs24\cf6\f1\fs20\snext0 Character textElement;}</xsl:text>
				<xsl:text>{\*\cs25\cf7\f1\fs20\snext0 Character textAttr;}</xsl:text>
				<xsl:text>{\*\cs26\cf3\f1\fs20\snext0 Character textContents;}</xsl:text>
				<xsl:text>{\*\cs27\cf3\f1\fs20\snext0 Character elementHeader;}</xsl:text>
				<xsl:text>{\*\cs28\cf3\f1\fs20\b\snext0 Character elementHeader2;}</xsl:text>
				<xsl:text>}</xsl:text>
